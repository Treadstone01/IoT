...
# Load your trained LSTM inference pipeline
try:
...
# Store the latest prediction (updated every minute in the background)
...
async def prediction_loop():
    ...
    while True:
        if pipeline:
            try:
                pred = pipeline.predict()  # should return dict with all values
                latest_prediction = PredictionResponse(**pred)
